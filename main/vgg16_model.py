...
class Vgg16(BaseModel):
    ...
    def _train_top_model(self, n_epochs, batch_size, save_history):
    ...
    def train(
        ...
        history = self._train_top_model(batch_size=batch_size, n_epochs=n_epochs, save_history=save_history)
        return history
...
if __name__ == '__main__':
    ...
    # TODO: fix bug: weights are not specific for data_id
    ...
    # history = model.train(data=data, batch_size=32, n_epochs=4, save_history=True)
